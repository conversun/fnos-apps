...
- 基于 [AdGuardHome v${VERSION}](https://github.com/AdguardTeam/AdGuardHome/releases/tag/v${VERSION})
- 平台: fnOS
- 默认端口: ${DEFAULT_PORT} (Web UI), 53 (DNS)${REVISION_NOTE}

> **注意**: 端口 53 可能与系统 DNS 服务冲突
